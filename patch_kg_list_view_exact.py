...
old_header_right = """        <form onSubmit={handleSearch} style={{ display: 'flex', gap: '8px', alignItems: 'center', flexWrap: 'wrap' }}>"""

new_header_right = """        <form onSubmit={handleSearch} style={{ display: 'flex', gap: '8px', alignItems: 'center', flexWrap: 'wrap' }}>
...
if "NetworkIcon size={14}" not in content:
...
if "List View Knowledge Graph" not in content:
    content = content.replace(old_graph_container, new_graph_container)

with open(filepath, "w", encoding="utf-8") as f:
    f.write(content)
print("List View mode implemented successfully with exact string matches.")
